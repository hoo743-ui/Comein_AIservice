...
const DICT = {
  ...
  "set.mode": { ko: "사용 모드", en: "Mode" },
  "set.modeDesc": { ko: "기본 장소·라벨 프리셋", en: "Default places & labels" },
  "set.modeRow": { ko: "사용 유형", en: "Usage type" },
  "set.modeRowDesc": { ko: "학생 · 직장인 · 일반", en: "Student · Office · General" },
  "set.modeStudent": { ko: "학생", en: "Student" },
  "set.modeOffice": { ko: "직장인", en: "Office" },
  "set.modeGeneral": { ko: "일반", en: "General" },
